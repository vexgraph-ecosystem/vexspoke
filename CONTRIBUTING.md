...
Therefore, **I do not accept any Pull Requests, feature requests, or external contributions of any kind. (yet, yes, yet.)**

Feel free to fork the code or use it as inspiration for your own zero-GC experiments, but this upstream repository will remain exclusively managed by its sole author.
...
| **Foreign Memory Bridge (FFM)** | All primitives, structs, arrays, matrices, and strings live off-heap via raw pointers. |
