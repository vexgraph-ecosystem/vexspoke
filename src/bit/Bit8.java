...
@Volatile
@HotCode
@Intention("Bit-width memory pool: decouples physical 8-bit allocation from type semantics. the 8-bit primitives delegate here, sharing one lockless pool for cross-type slot recycling.")
public final class Bit8
{
    // --- SLOT WIDTHS ---
    public static final int ELEMENT_SIZE = 1; // bytes per element (Bit8: Byte, Bool)
