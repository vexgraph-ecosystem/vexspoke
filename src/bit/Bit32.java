...
@Volatile
@HotCode
@Intention("Bit-width memory pool: decouples physical 32-bit allocation from type semantics. Int, Float, Fixed32 all delegate here, sharing one lockless pool for cross-type slot recycling.")
public final class Bit32
{
    // --- SLOT WIDTHS ---
    public static final int ELEMENT_SIZE = 4; // bytes per element (Bit32: Int, Float, Fixed32)
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(106), long.class);
            ARRAY_FREE_HEAD_8_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(107), long.class);
            ARRAY_FREE_HEAD_32_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(108), long.class);
            ARRAY_FREE_HEAD_128_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(109), long.class);
            ARRAY_FREE_HEAD_512_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(110), long.class);
            MATRIX_FREE_HEAD_8_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(7), long.class);
            MATRIX_FREE_HEAD_32_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(5), long.class);
            MATRIX_FREE_HEAD_128_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(4), long.class);
            MATRIX_FREE_HEAD_512_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(6), long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(111), int.class);
            ARRAY_EXPANDING_8_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(112), int.class);
            ARRAY_EXPANDING_32_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(113), int.class);
            ARRAY_EXPANDING_128_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(114), int.class);
            ARRAY_EXPANDING_512_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(115), int.class);
            MATRIX_EXPANDING_8_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(116), int.class);
            MATRIX_EXPANDING_32_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(117), int.class);
            MATRIX_EXPANDING_128_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(118), int.class);
            MATRIX_EXPANDING_512_VH = lookup.findStaticVarHandle(Bit32.class, StringLookup.getJavaString(119), int.class);
        }
    ...
    {
        if(!active) throw new IllegalStateException(StringLookup.getJavaString(124));
    }
