...
public final class LongDouble {
    ...
    public static double getFracPart(long pointer) {
        if (pointer == 0L) throw new NullPointerException("Accessing NULL off-heap pointer!");
        return ForeignMemory.unsafeGetDouble(pointer + 8L);
    }

    public static double getAsDouble(long pointer) {
        if (pointer == 0L) throw new NullPointerException("Accessing NULL off-heap pointer!");
        return ForeignMemory.unsafeGetLong(pointer) + ForeignMemory.unsafeGetDouble(pointer + 8L);
    }

    public static long getIntPart(long pointer, int index) {
        checkBounds(pointer, index);
        return ForeignMemory.unsafeGetLong(pointer + (index * 16L));
    }

    public static double getFracPart(long pointer, int index) {
        checkBounds(pointer, index);
        return ForeignMemory.unsafeGetDouble(pointer + (index * 16L) + 8L);
    }

    public static double getAsDouble(long pointer, int index) {
        checkBounds(pointer, index);
        return ForeignMemory.unsafeGetLong(pointer + (index * 16L)) + ForeignMemory.unsafeGetDouble(pointer + (index * 16L) + 8L);
    }
    ...
    public static void set(long pointer, int index, long intPart, double fracPart) {
        checkBounds(pointer, index);
        if (classId(pointer) != CLASS_ID) throw new IllegalArgumentException("Pointer 0x" + java.lang.Long.toHexString(pointer).toUpperCase() + " is Class ID " + classId(pointer) + ", expected LongDouble (Class ID " + CLASS_ID + ")");
        ForeignMemory.unsafeSet(pointer + (index * 16L), intPart);
        ForeignMemory.unsafeSet(pointer + (index * 16L) + 8L, fracPart);
    }
    ...
    @Unsafe
    public static void unsafeSet(long pointer, long val1, double val2) {
        ForeignMemory.unsafeSet(pointer, val1);
        ForeignMemory.unsafeSet(pointer + 8L, val2);
    }

    @Unsafe
    public static void unsafeSet(long pointer, int index, long val1, double val2) {
        ForeignMemory.unsafeSet(pointer + (index * 16L), val1);
        ForeignMemory.unsafeSet(pointer + (index * 16L) + 8L, val2);
    }

    @Volatile
    public static long getLongPartVolatile(long pointer, int index) {
        checkBounds(pointer, index);
        return ForeignMemory.unsafeGetLongVolatile(pointer + (index * 16L));
    }

    @Volatile
    public static double getDoublePartVolatile(long pointer, int index) {
        checkBounds(pointer, index);
        return ForeignMemory.unsafeGetDoubleVolatile(pointer + (index * 16L) + 8L);
    }

    @Volatile
    public static void setVolatile(long pointer, int index, long val1, double val2) {
        checkBounds(pointer, index);
        ForeignMemory.unsafeVolatileSet(pointer + (index * 16L), val1);
        ForeignMemory.unsafeVolatileSet(pointer + (index * 16L) + 8L, val2);
    }
    ...
    @Unsafe
    @Volatile
    public static void unsafeVolatileSet(long pointer, int index, long val1, double val2) {
        ForeignMemory.unsafeVolatileSet(pointer + (index * 16L), val1);
        ForeignMemory.unsafeVolatileSet(pointer + (index * 16L) + 8L, val2);
    }
}
