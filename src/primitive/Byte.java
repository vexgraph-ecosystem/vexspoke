...
public final class Byte {
    ...
    static {
        try {
            ...
            ARRAY_FREE_HEAD_8_VH = lookup.findStaticVarHandle(Byte.class, "arrayFreeHead8", long.class);
            ARRAY_FREE_HEAD_32_VH = lookup.findStaticVarHandle(Byte.class, "arrayFreeHead32", long.class);
            ARRAY_FREE_HEAD_128_VH = lookup.findStaticVarHandle(Byte.class, "arrayFreeHead128", long.class);
            ARRAY_FREE_HEAD_512_VH = lookup.findStaticVarHandle(Byte.class, "arrayFreeHead512", long.class);
            MATRIX_FREE_HEAD_8_VH = lookup.findStaticVarHandle(Byte.class, "matrixFreeHead8", long.class);
            MATRIX_FREE_HEAD_32_VH = lookup.findStaticVarHandle(Byte.class, "matrixFreeHead32", long.class);
            MATRIX_FREE_HEAD_128_VH = lookup.findStaticVarHandle(Byte.class, "matrixFreeHead128", long.class);
            MATRIX_FREE_HEAD_512_VH = lookup.findStaticVarHandle(Byte.class, "matrixFreeHead512", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(Byte.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_8_VH = lookup.findStaticVarHandle(Byte.class, "arrayExpanding8", int.class);
            ARRAY_EXPANDING_32_VH = lookup.findStaticVarHandle(Byte.class, "arrayExpanding32", int.class);
            ARRAY_EXPANDING_128_VH = lookup.findStaticVarHandle(Byte.class, "arrayExpanding128", int.class);
            ARRAY_EXPANDING_512_VH = lookup.findStaticVarHandle(Byte.class, "arrayExpanding512", int.class);
            MATRIX_EXPANDING_8_VH = lookup.findStaticVarHandle(Byte.class, "matrixExpanding8", int.class);
            MATRIX_EXPANDING_32_VH = lookup.findStaticVarHandle(Byte.class, "matrixExpanding32", int.class);
            MATRIX_EXPANDING_128_VH = lookup.findStaticVarHandle(Byte.class, "matrixExpanding128", int.class);
            MATRIX_EXPANDING_512_VH = lookup.findStaticVarHandle(Byte.class, "matrixExpanding512", int.class);
        }
...
public static byte get(long pointer) {
    ...
    public static void set(long pointer, byte value) {
        ...
        ForeignMemory.putByte(pointer, value);
    }
    ...
    public static byte unsafeGet(long pointer, int index) {
        return ForeignMemory.getByte(pointer + (index * 1L));
    }
    ...
    public static void unsafeSet(long pointer, int index, byte value) {
        ForeignMemory.putByte(pointer + (index * 1L), value);
    }
    ...
    public static byte getVolatile(long pointer, int index) {
        checkBounds(pointer, index);
        return ForeignMemory.getByteVolatile(pointer + (index * 1L));
    }
    ...
    public static void setVolatile(long pointer, int index, byte value) {
        checkBounds(pointer, index);
        ForeignMemory.putByteVolatile(pointer + (index * 1L), value);
    }
