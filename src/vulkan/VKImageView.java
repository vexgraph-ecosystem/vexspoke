...
public final class VKImageView {
    ...
    @Required
    public static final int CLASS_ID = TypeRegister.ID_VK_IMAGE_VIEW;

    public static final long MAX_VALUE = 9223372036854775807L;
    public static final long MIN_VALUE = -9223372036854775808L;

    public static final int TYPE_SINGLETON = TypeRegister.VK_IMAGE_VIEW_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.VK_IMAGE_VIEW_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.VK_IMAGE_VIEW_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(VKImageView.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(VKImageView.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(VKImageView.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(VKImageView.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(VKImageView.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(VKImageView.class, "matrixExpanding", int.class);
    ...
    private static void checkActive() {
        if (!active) throw new IllegalStateException("VKImageView subsystem is not active!");
    }
    ...
    public static long create(VkDevice device, long image, int format, int aspectFlags) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            set(enginePtr, pImageView.get(0));
        }
        return enginePtr;
    }
    ...
    public static void destroy(long enginePtr, VkDevice device) {
        ...
        if(vkHandle != 0L) {
            vkDestroyImageView(device, vkHandle, null);
            set(enginePtr, 0L);
        }
        free(enginePtr);
    }
