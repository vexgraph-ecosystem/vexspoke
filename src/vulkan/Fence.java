...
public final class Fence {
    ...
    @Required
    public static final int CLASS_ID = TypeRegister.ID_FENCE;

    public static final long MAX_VALUE = 9223372036854775807L;
    public static final long MIN_VALUE = -9223372036854775808L;

    public static final int TYPE_SINGLETON = TypeRegister.FENCE_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.FENCE_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.FENCE_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(Fence.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(Fence.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(Fence.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(Fence.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(Fence.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(Fence.class, "matrixExpanding", int.class);
    ...
    private static void checkActive() {
        if (!active) throw new IllegalStateException("Fence subsystem is not active!");
    }
    ...
    // --- VULKAN FACTORY ---
    public static long create(VkDevice device, boolean signaled) {
    ...
    public static void destroy(long enginePtr, VkDevice device) {
        ...
        if(vkHandle != 0L) {
            vkDestroyFence(device, vkHandle, null);
            set(enginePtr, 0L);
        }
        free(enginePtr);
    }
