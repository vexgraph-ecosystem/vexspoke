...
public final class VKShaderModule {
    ...
    @Required
    public static final int CLASS_ID = TypeRegister.ID_VK_SHADER_MODULE;

    public static final long MAX_VALUE = 9223372036854775807L;
    public static final long MIN_VALUE = -9223372036854775808L;

    public static final int TYPE_SINGLETON = TypeRegister.VK_SHADER_MODULE_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.VK_SHADER_MODULE_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.VK_SHADER_MODULE_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(VKShaderModule.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(VKShaderModule.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(VKShaderModule.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(VKShaderModule.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(VKShaderModule.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(VKShaderModule.class, "matrixExpanding", int.class);
    ...
    private static void checkActive() {
        if (!active) throw new IllegalStateException("VKShaderModule subsystem is not active!");
    }
    ...
    // --- VULKAN FACTORY ---
    public static long create(VkDevice device, ByteBuffer spvCode) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (vkCreateShaderModule(device, createInfo, null, pShaderModule) != VK_SUCCESS) {
                throw new RuntimeException("Failed to create VKShaderModule!");
            }
            set(enginePtr, pShaderModule.get(0));
        }
        return enginePtr;
    }
    ...
    public static void destroy(long enginePtr, VkDevice device) {
        ...
        if(vkHandle != 0L) {
            vkDestroyShaderModule(device, vkHandle, null);
            set(enginePtr, 0L);
        }
        free(enginePtr);
    }
