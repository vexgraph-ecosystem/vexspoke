...
public final class VKTexture {
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(VKTexture.class, "singletonFreeHead", long.class);
            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(VKTexture.class, "singletonExpanding", int.class);
    ...
    private static void checkActive() {
        if (!active) throw new IllegalStateException("VKTexture subsystem is not active!");
    }
