...
@Draft
public final class PostProcessingBuffer {

    @Required
    public static final int CLASS_ID = TypeRegister.ID_POST_PROCESSING_BUFFER;

    public static final long MAX_VALUE = 9223372036854775807L;
    public static final long MIN_VALUE = -9223372036854775808L;

    public static final int TYPE_SINGLETON = TypeRegister.POST_PROCESSING_BUFFER_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.POST_PROCESSING_BUFFER_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.POST_PROCESSING_BUFFER_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(PostProcessingBuffer.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(PostProcessingBuffer.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(PostProcessingBuffer.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(PostProcessingBuffer.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(PostProcessingBuffer.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(PostProcessingBuffer.class, "matrixExpanding", int.class);
    ...
    private PostProcessingBuffer() {}

    private static void checkActive() {
        if (!active) throw new IllegalStateException("PostProcessingBuffer subsystem is not active!");
    }
    ...
    public static long create(int width, int height) {
        ...
        // TODO: Backend-specific memory punching (Vulkan/Metal)
        return enginePtr;
    }
