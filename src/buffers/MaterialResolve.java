...
@Draft
public final class MaterialResolve {

    @Required
    public static final int CLASS_ID = TypeRegister.ID_MATERIAL_RESOLVE;

    public static final long MAX_VALUE = 9223372036854775807L;
    public static final long MIN_VALUE = -9223372036854775808L;

    public static final int TYPE_SINGLETON = TypeRegister.MATERIAL_RESOLVE_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.MATERIAL_RESOLVE_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.MATERIAL_RESOLVE_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(MaterialResolve.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(MaterialResolve.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(MaterialResolve.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(MaterialResolve.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(MaterialResolve.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(MaterialResolve.class, "matrixExpanding", int.class);
    ...
    private MaterialResolve() {}

    private static void checkActive() {
        if (!active) throw new IllegalStateException("MaterialResolve subsystem is not active!");
    }
