...
public final class PhysicalBuffer {
    ...
    public static final int TYPE_SINGLETON = TypeRegister.PHYSICAL_BUFFER_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.PHYSICAL_BUFFER_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.PHYSICAL_BUFFER_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(PhysicalBuffer.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(PhysicalBuffer.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(PhysicalBuffer.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(PhysicalBuffer.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(PhysicalBuffer.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(PhysicalBuffer.class, "matrixExpanding", int.class);
    ...
    private static void checkActive() {
        if (!active) throw new IllegalStateException("PhysicalBuffer subsystem is not active!");
    }
