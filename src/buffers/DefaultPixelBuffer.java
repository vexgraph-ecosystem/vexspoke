...
@Draft
public final class DefaultPixelBuffer {

    @Required
    public static final int CLASS_ID = TypeRegister.ID_DEFAULT_PIXEL_BUFFER;

    public static final long MAX_VALUE = 9223372036854775807L;
    public static final long MIN_VALUE = -9223372036854775808L;

    public static final int TYPE_SINGLETON = TypeRegister.DEFAULT_PIXEL_BUFFER_SINGLETON; // 0xAA000002
    public static final int TYPE_ARRAY     = TypeRegister.DEFAULT_PIXEL_BUFFER_ARRAY;     // 0xBB000002
    public static final int TYPE_MATRIX    = TypeRegister.DEFAULT_PIXEL_BUFFER_POINTER;   // 0xCC000002
    ...
    static {
        try {
            ...
            SINGLETON_FREE_HEAD_VH = lookup.findStaticVarHandle(DefaultPixelBuffer.class, "singletonFreeHead", long.class);
            ARRAY_FREE_HEAD_VH = lookup.findStaticVarHandle(DefaultPixelBuffer.class, "arrayFreeHead", long.class);
            MATRIX_FREE_HEAD_VH = lookup.findStaticVarHandle(DefaultPixelBuffer.class, "matrixFreeHead", long.class);

            SINGLETON_EXPANDING_VH = lookup.findStaticVarHandle(DefaultPixelBuffer.class, "singletonExpanding", int.class);
            ARRAY_EXPANDING_VH = lookup.findStaticVarHandle(DefaultPixelBuffer.class, "arrayExpanding", int.class);
            MATRIX_EXPANDING_VH = lookup.findStaticVarHandle(DefaultPixelBuffer.class, "matrixExpanding", int.class);
    ...
    private DefaultPixelBuffer() {}

    private static void checkActive() {
        if (!active) throw new IllegalStateException("DefaultPixelBuffer subsystem is not active!");
    }
