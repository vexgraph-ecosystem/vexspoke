...
#define ID_CIRCLE_ARRAY 0x0037u
#define ID_SPHERE_ARRAY 0x0038u
#define ID_OCTREE       0x0039u
#define ID_CRYPTO       0x003Au
...
#define ID_SHELF 0x008Eu
#define ID_SHELF_NODE 0x008Fu
#define ID_SEGMENT_INDEX 0x0090u
#define ID_SEGMENT_ENTRY 0x0091u
#define ID_SEGMENT_POSTING 0x0092u
#define ID_VARIABLE_MINI_MAP 0x0093u
#define ID_REFLECT_CLASS 0x0094u
#define ID_REFLECT_FIELD 0x0095u
#define ID_REFLECT_VARIABLE 0x0096u
#define ID_REFLECT_METHOD 0x0097u
#define ID_REFLECT_STRUCT 0x0099u
#define ID_REACTIVE_BOOL 0x009Au
#define ID_REACTIVE_CHAR 0x009Bu
#define ID_REACTIVE_SHORT 0x009Cu
#define ID_REACTIVE_INT 0x009Du
#define ID_REACTIVE_LONG 0x009Eu
#define ID_REACTIVE_FLOAT 0x009Fu
#define ID_REACTIVE_DOUBLE 0x00A0u
#define ID_REACTIVE_STRING 0x00A1u
#define ID_REACTIVE_INT_FLOAT 0x00A2u
#define ID_REACTIVE_INT_DOUBLE 0x00A3u
#define ID_REACTIVE_LONG_FLOAT 0x00A4u
#define ID_REACTIVE_LONG_DOUBLE 0x00A5u
...
#define TYPE_SHELF                  (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_SHELF)
#define TYPE_SEGMENT_INDEX          (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_SEGMENT_INDEX)
#define TYPE_VARIABLE_MINI_MAP      (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_VARIABLE_MINI_MAP)
#define TYPE_REFLECT_CLASS          (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_REFLECT_CLASS)
#define TYPE_REFLECT_FIELD          (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_REFLECT_FIELD)
#define TYPE_REFLECT_VARIABLE       (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_REFLECT_VARIABLE)
#define TYPE_REFLECT_METHOD         (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_REFLECT_METHOD)
#define TYPE_REFLECT_STRUCT         (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_REFLECT_STRUCT)
#define TYPE_REACTIVE_BOOL          (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_BOOL)
#define TYPE_REACTIVE_CHAR          (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_CHAR)
#define TYPE_REACTIVE_SHORT         (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_SHORT)
#define TYPE_REACTIVE_INT           (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_INT)
#define TYPE_REACTIVE_LONG          (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_LONG)
#define TYPE_REACTIVE_FLOAT         (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_FLOAT)
#define TYPE_REACTIVE_DOUBLE        (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_DOUBLE)
#define TYPE_REACTIVE_STRING        (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_STRING)
#define TYPE_REACTIVE_INT_FLOAT     (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_INT_FLOAT)
#define TYPE_REACTIVE_INT_DOUBLE    (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_INT_DOUBLE)
#define TYPE_REACTIVE_LONG_FLOAT    (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_LONG_FLOAT)
#define TYPE_REACTIVE_LONG_DOUBLE   (PROJ_VEXSPOKE | FORM_SINGLETON | WRAP_REACTIVE | ID_REACTIVE_LONG_DOUBLE)
...
#define TYPE_CIRCLE_ARRAY            (PROJ_VEXSPOKE | FORM_ARRAY     | ID_CIRCLE_ARRAY)
#define TYPE_SPHERE_ARRAY            (PROJ_VEXSPOKE | FORM_ARRAY     | ID_SPHERE_ARRAY)
#define TYPE_OCTREE                  (PROJ_VEXSPOKE | FORM_STRUCT_SINGLETON | ID_OCTREE)
#define TYPE_CRYPTO                  (PROJ_VEXSPOKE | FORM_SINGLETON | ID_CRYPTO)
...
#define TYPE_WS_CLIENT_SINGLETON     (PROJ_VEXSPOKE | FORM_SINGLETON | ID_WS_CLIENT)
#define TYPE_PROCESS_SPAWN_SINGLETON (PROJ_VEXSPOKE | FORM_SINGLETON | ID_PROCESS_SPAWN)
